                                ...
                                <div class="row">
                                    <div class="col-md-12 col-sm-12 col-xs-12">
                                        <table class="table">
                                            ...
                                            <tbody>
											<input id="basicInfoScore" type="hidden" value="{{ $result['basicInfoScore'] }}"/>
											...
											<input id="communicationRecordScore" type="hidden" value="{{ $result['communicationRecordScore'] }}"/>											
                                                ...
                                                <tr class="success">
                                                    <td>13</td>
                                                    <td>与已有客户通话时长</td>
                                                    <td><?php echo $result['mostFrequentNumber'] ?></td>
                                                </tr>
                        ...
                        <div class="portlet"><!-- /primary heading -->
                            ...
                            <div id="portlet5" class="panel-collapse collapse in">
                                <div class="portlet-body">
                                    <canvas id="radarBefore" data-type="Radar" width="300" height="300"></canvas>
                                </div>
                            </div>
                        </div>
