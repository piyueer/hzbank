                    ...
                    <div class="col-md-12">
                        <div class="panel panel-color panel-purple">
                            <div class="panel-heading">
                                <h3 class="panel-title">过去一周内的贷后查询记录</h3>
                            </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12 col-sm-12 col-xs-12">
										...
										<div class="panel-body"> 
											...
											<table id="lastWeekAfter" class="table table-striped table-bordered">
												<thead>
													<tr>
														<th>姓名</th>
														<th>身份证号码</th>
...
$(document).ready(function() {
	var table = $('#lastWeekAfter').DataTable( {
		...
		{ "width": "25%","orderable": false, "targets": 3,  
			render: function (data, type, row, meta) {
				return "<a class='md-trigger btn  btn-info btn-xs m-b-4' href='{{url('After/singledetails')}}?uid=" + data + "'>查看详细</a>";
			} 
		}
		],
		...
		"ajax": {
			"url": '{!! route('datatables.lastweekdataafter') !!}'
		},
